...
$(document).ready(function() {
  ...
  */
  function followingHoverIn(e) {
    ...
    if (t.hasClass('btn-primary') && span.hasClass('fa-ok')) {
      t.removeClass('btn-primary').addClass('btn-danger');
      span.removeClass('fa-ok').addClass('fa-remove');
      text.text('Unfollow');
    }
  }
  ...
  function followingHoverOut(e) {
    ...
    if (t.hasClass('btn-danger') && span.hasClass('fa-remove')) {
      t.addClass('btn-primary').removeClass('btn-danger');
      span.removeClass('fa-remove').addClass('fa-ok');
      text.text('Following');
    }
  }
