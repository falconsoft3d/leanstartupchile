 ...
 /* -----------------------------
    ...
    $window.keydown(function (eventObject) {
        if (eventObject.which == 27) {
			...
			$('.oly-menu').removeClass('expanded-menu');
			$('.popup-chat-responsive').removeClass('open-chat');
			$('.oly-settings-responsive').removeClass('open');
	...
	$(".oly-settings-open").on('click', function () {
		$('.oly-settings-responsive').toggleClass('open');
		return false
	});

	$(".js-expanded-menu").on('click', function () {
		$('.oly-menu').toggleClass('expanded-menu');
		return false
	});
